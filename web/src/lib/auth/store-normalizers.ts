...
export function repairKnownMojibakeText(value: string) {
    if (value.includes("StartFlows") && value.includes("AI") && !value.includes("绘图") && value.includes(",")) return DEFAULT_SITE_SETTINGS.seoKeywords;
    if (value.includes("StartFlows") && value.includes("AI") && !value.includes("工作台") && !value.includes("绘图")) return DEFAULT_SITE_SETTINGS.seoDescription;
    if (value.includes("2026 StartFlows") && !value.startsWith("©")) return "© 2026 StartFlows. All rights reserved.";
