...
const FlowCanvasLibraryPage = dynamic(() => import("@/flowcanvas/canvas/page"), { ssr: false });
...
export default function CanvasPage() {
    ...
    return <FlowcanvasAntdScope>{workspaceReady ? <FlowCanvasLibraryPage /> : <BackendWorkspaceGate title="账号工作区" />}</FlowcanvasAntdScope>;
}
